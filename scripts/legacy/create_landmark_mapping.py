#!/usr/bin/env python3
"""
Utility to write a landmark-to-model vertex mapping file with a target count (default 15–25).

Usage examples:
  # Write a new mapping with explicit pairs (landmark:model)
  python scripts/utils/create_landmark_mapping.py \
...
def save_mapping(path: Path, mapping: Dict[int, int]) -> None:
    lines = [
        ...
        "# Generated by scripts/utils/create_landmark_mapping.py",
        "",
    ]
